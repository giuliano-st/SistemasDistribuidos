    ...
    private void aguardaClientes() {
        while (true) {
            try {
                ...
                System.out.println("Recebi uma conexão de um cliente do endereço: "+ cliente.getInetAddress() + " usando a porta " + cliente.getPort());
                //servidor recebendo uma msg do cliente
